...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ServicePayload :  IEquatable<ServicePayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServicePayload" /> class.
        /// </summary>
        ...
        public ServicePayload(string name = default(string), int? duration = default(int?), decimal? price = default(decimal?), string currency = default(string), string location = default(string), string description = default(string), string availabilitiesType = default(string), int? attendantsNumber = default(int?), int? categoryId = default(int?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as ServicePayload);
        }

        /// <summary>
        /// Returns true if ServicePayload instances are equal
        /// </summary>
        /// <param name="input">Instance of ServicePayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServicePayload input)
        {
            if (input == null)
                return false;
