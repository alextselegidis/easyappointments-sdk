...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SecretaryPayload', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.SecretaryPayload();
      });

      it('should create an instance of SecretaryPayload', function() {
        // TODO: update the code to test SecretaryPayload
        expect(instance).to.be.a(EasyappointmentsApi.SecretaryPayload);
      });
