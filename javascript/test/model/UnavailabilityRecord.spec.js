...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UnavailabilityRecord', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.UnavailabilityRecord();
      });

      it('should create an instance of UnavailabilityRecord', function() {
        // TODO: update the code to test UnavailabilityRecord
        expect(instance).to.be.a(EasyappointmentsApi.UnavailabilityRecord);
      });
      ...
      it('should have the property book (base name: "book")', function() {
        // TODO: update the code to test the property book
        expect(instance).to.have.property('book');
        // expect(instance.book).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property googleCalendarId (base name: "googleCalendarId")', function() {
        // TODO: update the code to test the property googleCalendarId
        expect(instance).to.have.property('googleCalendarId');
        // expect(instance.googleCalendarId).to.be(expectedValueLiteral);
      });
