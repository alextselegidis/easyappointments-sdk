...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProviderRecord', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.ProviderRecord();
      });

      it('should create an instance of ProviderRecord', function() {
        // TODO: update the code to test ProviderRecord
        expect(instance).to.be.a(EasyappointmentsApi.ProviderRecord);
      });
