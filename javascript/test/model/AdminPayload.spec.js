...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdminPayload', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.AdminPayload();
      });

      it('should create an instance of AdminPayload', function() {
        // TODO: update the code to test AdminPayload
        expect(instance).to.be.a(EasyappointmentsApi.AdminPayload);
      });
