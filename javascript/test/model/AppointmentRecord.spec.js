...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppointmentRecord', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.AppointmentRecord();
      });

      it('should create an instance of AppointmentRecord', function() {
        // TODO: update the code to test AppointmentRecord
        expect(instance).to.be.a(EasyappointmentsApi.AppointmentRecord);
      });
