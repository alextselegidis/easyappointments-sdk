...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppointmentCollection', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.AppointmentCollection();
      });

      it('should create an instance of AppointmentCollection', function() {
        // TODO: update the code to test AppointmentCollection
        expect(instance).to.be.a(EasyappointmentsApi.AppointmentCollection);
      });
