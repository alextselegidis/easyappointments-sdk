...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdminRecord', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.AdminRecord();
      });

      it('should create an instance of AdminRecord', function() {
        // TODO: update the code to test AdminRecord
        expect(instance).to.be.a(EasyappointmentsApi.AdminRecord);
      });
