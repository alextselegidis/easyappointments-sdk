...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppointmentPayload', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.AppointmentPayload();
      });

      it('should create an instance of AppointmentPayload', function() {
        // TODO: update the code to test AppointmentPayload
        expect(instance).to.be.a(EasyappointmentsApi.AppointmentPayload);
      });
