...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProviderPayload', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.ProviderPayload();
      });

      it('should create an instance of ProviderPayload', function() {
        // TODO: update the code to test ProviderPayload
        expect(instance).to.be.a(EasyappointmentsApi.ProviderPayload);
      });
