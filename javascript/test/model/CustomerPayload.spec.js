...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomerPayload', function() {
      beforeEach(function() {
        instance = new EasyappointmentsApi.CustomerPayload();
      });

      it('should create an instance of CustomerPayload', function() {
        // TODO: update the code to test CustomerPayload
        expect(instance).to.be.a(EasyappointmentsApi.CustomerPayload);
      });
